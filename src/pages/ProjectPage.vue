<template>
  <section class="px-5 pt-32 m:px-10">
    <div
      class="flex flex-col mx-auto max-w-7xl animate-fade-up animate-duration-[1500ms] animate-ease-out"
    >
      <div class="w-full mt-12">
        ...
        >
          <h2
            class="text-2xl font-[Montserrat-Bold] tracking-[0.54px] text-white mb-4"
          >
            Interactive Project Demo
          </h2>
          <p
            class="text-gray-400 tracking-[0.42px] font-[Montserrat-Regular] max-w-2xl mx-auto"
          >
          ...
          >
            ...
            >
              <div class="text-center text-white">
                <div
                  class="w-8 h-8 mx-auto grid space-y-2 -my-16 justify-center place-items-center"
                >
                  <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8 5v14l11-7z"></path>
                  </svg>
                  <span class="text-xs font-[Montserrat-Medium] text-nowrap"
                    >Launch Demo</span
                  >
                </div>
              </div>
            ...
            <div>
              <h3 class="font-bold text-white tracking-[0.48px] mb-2">
                {{ project.title }}
              </h3>
              <p
                v-if="!expanded"
                class="text-sm text-gray-400 tracking-[0.42px] line-clamp-2"
              >
                <template v-if="index === 0">
                  {{ truncateText(project.description, 10) }}
                  <span v-if="project.description.split(' ').length > 10"
                    >...</span
                  >
                </template>
                <template v-else>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <div class="pr-12">
                <h3
                  class="text-xl font-[Montserrat-Bold] text-white tracking-[0.48px]"
                >
              ...
              >
                <svg
                  class="w-8 h-8 animate-spin text-red-500 mb-3"
                  fill="none"
                  viewBox="0 0 24 24"
                >
                  <circle
              ...
              <div
                v-if="githubLink"
                v-show="!isLoading"
                class="absolute bottom-4 right-4 inline-block"
              >
                <div
          ...
          <div
            v-else
            class="py-12 text-center animate-fade-up animate-duration-[1500ms] animate-delay-[600ms] animate-ease-out"
          >
            ...
            <p class="text-gray-400 tracking-[0.42px] max-w-md mx-auto">
              Choose any project from the grid above for a preview.
            </p>
          </div>
        </div>
      </div>
...
const projects = [
  ...
  },
  {
    id: 2,
    title: "Portfolio",
    url: new URL("@/assets/potfolio.png", import.meta.url).href,
    description:
  ...
  {
    id: 5,
    title: "A food delivery app mobile screen",
    url: new URL("@/assets/ASS1.png", import.meta.url).href,
    description:

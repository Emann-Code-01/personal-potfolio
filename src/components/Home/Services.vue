<template>
  ...
  >
    ...
    <p
      class="text-white opacity-30 text-sm tracking-[0.42px] mb-12 font-[Montserrat-SemiBold]"
    >
    ...
    >
      ...
      >
        ...
        <p
          class="text-white text-opacity-40 text-sm mb-[26px] font-[Montserrat-SemiBold]"
        >
      ...
      <div
        class="text-center py-[50px] px-[65.5px] bg-white bg-opacity-[4%] border border-transparent duration-300 hover:border-[#FFFFFF1A] rounded-[6px] hover:bg-primary hover:bg-opacity-40 transition-all ease-out"
      >
        <h4 class="mb-4 font-[Montserrat-Bold] text-nowrap">
